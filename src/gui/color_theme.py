...
class DarkTheme:
    ...
    LISTENED_BACKGROUND_COLOR = QColor(0, 0, 0)
    LISTENED_FOREGROUND_COLOR = QColor(130, 130, 130)
...
class LightTheme:
    ...
    LISTENED_BACKGROUND_COLOR = QColor(220, 220, 220)
    LISTENED_FOREGROUND_COLOR = QColor(130, 130, 130)
...
current_theme = next((t for t in [DarkTheme, LightTheme] if t.NAME == g_settings.ui_color_theme), DarkTheme)
